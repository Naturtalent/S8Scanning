...
public class NetworkFragment extends Fragment
{
    ...
    private class DownloadTask extends AsyncTask<String, Integer, DownloadTask.Result>
    {
        ...
        /**
         * Stellt eine Verbindung zur 'url' her und holt den HTTP Antworttext vom Server ab.
         * Ist dies erfolgreich, wird der Anworttext zurueckgegeben andernfalls erfolgt eine IOException
         *
